      ...
      <main className="min-h-[calc(100vh-210px)] sm:min-h-0 mt-10 sm:mt-20">
        <section className="grid grid-cols-12 gap-5 place-items-center container mx-auto px-8">
          <div className=" col-span-12 lg:col-span-7">
            ...
            <p>
              <span className=" font-semibold text-lg">Krakatau Citra Indonesia Tour & Travel</span> merupakan
              perusahaan yang bergerak dibidang Perjalanan Umum dan Jasa Pelayanan Umroh dan Pariwisata dalam dan luar
              Negeri yang di Pimpin oleh Bpk. Amru Taufan Alamsyah.
            </p>
            <p className="mt-2">
